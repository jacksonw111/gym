...
// emas/functions/gym-admin-api/src/index.ts
var index_exports = {};
__export(index_exports, {
  createGymAdminEntrypoint: () => createGymAdminEntrypoint,
  main: () => main
});
...
// emas/functions/gym-admin-api/src/index.ts
var createGymAdminEntrypoint = (options) => async (context) => {
  ...
  let request;
  try {
    request = JSON.parse(readHttpBody(event));
  } catch {
    return composedJsonResponse(
      400,
      {
